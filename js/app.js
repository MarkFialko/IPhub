    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new core(".business__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".business__left",
                    nextEl: ".business__right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
